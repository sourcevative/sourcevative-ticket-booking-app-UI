...
export default function LoginPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) {
        // Normalize server errors to English for the UI
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <form onSubmit={onSubmit} className="w-full max-w-md space-y-5 rounded-xl border border-gray-200 bg-white backdrop-blur-sm p-8 shadow-lg">
        <div className="text-center space-y-2">
          <h1 className="text-gray-900 text-3xl font-bold">Login</h1>
        ...
        <div className="text-center">
          ...
          >
            ...
            <span className="text-blue-600 hover:text-blue-700 font-medium">Sign up here</span>
          </Link>
        </div>
      </form>
    </div>
