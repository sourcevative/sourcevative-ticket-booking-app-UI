...
<Badge
  onClick={async () => {
    await toggleBookingType(type.id, !type.is_active)
    await loadBookingTypes()
  }}
  ...
  {type.is_active ? "Active" : "Inactive"}
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* <Button
                    ...
                    className="flex-1"
                    onClick={async () => {
                      await updateBookingType(type.id, {
                        name: type.name,
                        description: type.description,
                        adult_price: type.adultPrice,
                        child_price: type.childPrice,
                        total_capacity: type.totalCapacity,
